<div class="flex justify-center flex-col w-7x1 h-full overflow-scroll text-white bg-white dark:bg-gray-800  rounded-xl bg-clip-border">
        ...
        <tbody>
            @foreach($collection as $attributes)
                <tr class="bg-neutral-primary border-b-3 border-gray-700">
                    @foreach($attributes->except(['id', '_token', 'deleted_at', 'created_at', 'updated_at']) as $key => $value)
